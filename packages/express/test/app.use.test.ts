...
describe('app', function(){
  it('should emit "mount" when mounted', function (done: any){
    const blog = express()
      , app = express();
  ...
  describe('.use(app)', function(){
    it('should mount the app', function (done: any){
      const blog = express()
        , app = express();

      blog.get('/blog', function (req: any, res: any){
        res.end('blog');
      });
    ...
    it('should support mount-points', function (done: any){
      const blog = express()
        , forum = express()
        , app = express();
      const cb = after(2, done)

      blog.get('/', function (req: any, res: any){
        res.end('blog');
      });

      forum.get('/', function (req: any, res: any){
        res.end('forum');
      });
    ...
    it('should support mounted app anywhere', function (done: any){
  ...
  describe('.use(middleware)', function(){
    ...
    it('should invoke middleware for all requests', function (done: any) {
      const app = express();
      const cb = after(3, done);
    ...
    it('should accept multiple arrays of middleware', function (done: any) {
      const app = express();
  ...
  describe('.use(path, middleware)', function(){
    ...
    it('should strip path from req.url', function (done: any) {
      ...
      app.use('/foo', function (req: any, res: any) {
        res.send('saw ' + req.method + ' ' + req.url);
      });
    ...
    it('should invoke middleware for all requests starting with path', function (done: any) {
      const app = express();
      const cb = after(3, done);
    ...
    it('should work if path has trailing slash', function (done: any) {
      const app = express();
      const cb = after(3, done);
    ...
    it('should support array of paths', function (done: any) {
      ...
      app.use(['/foo/', '/bar'], function (req: any, res: any) {
    ...
    it('should support array of paths with middleware array', function (done: any) {
      const app = express();
      const cb = after(2, done);
    ...
    it('should support regexp path', function (done: any) {
      ...
      app.use(/^\/[a-z]oo/, function (req: any, res: any) {
        res.send('saw ' + req.method + ' ' + req.url + ' through ' + req.originalUrl);
      });
    ...
    it('should support empty string path', function (done: any) {
      const app = express();
