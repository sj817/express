...
describe('req', function(){
  describe('.secure', function(){
    describe('when X-Forwarded-Proto is missing', function(){
      it('should return false when http', function (done: any){
        const app = express();
  ...
  describe('.secure', function(){
    describe('when X-Forwarded-Proto is present', function(){
      ...
      it('should return true when "trust proxy" is enabled', function (done: any){
        const app = express();
      ...
      it('should return false when initial proxy is http', function (done: any){
        const app = express();
      ...
      it('should return true when initial proxy is https', function (done: any){
        const app = express();
