...
describe('app', function(){
  describe('.render(name, fn)', function(){
    it('should support absolute paths', function (done: any){
      ...
      app.render(path.join(__dirname, 'fixtures', 'user.tmpl'), function (err: any, str: any) {
    ...
    it('should support absolute paths with "view engine"', function (done: any){
      ...
      app.render(path.join(__dirname, 'fixtures', 'user'), function (err: any, str: any) {
        if (err) return done(err);
        assert.strictEqual(str, '<p>tobi</p>')
        done();
      })
    ...
    it('should expose app.locals', function (done: any){
      ...
      app.render('user.tmpl', function (err: any, str: any) {
        if (err) return done(err);
        assert.strictEqual(str, '<p>tobi</p>')
        done();
      })
    ...
    it('should support index.<engine>', function (done: any){
      ...
      app.render('blog/post', function (err: any, str: any) {
        if (err) return done(err);
    ...
    it('should handle render error throws', function (done: any){
      const app = express();
      ...
      app.render('something', function (err: any, str: any){
        assert.ok(err)
    ...
    describe('when the file does not exist', function(){
      it('should provide a helpful error', function (done: any){
        const app = createApp();
    ...
    describe('when an extension is given', function(){
      it('should render the template', function (done: any){
        ...
        app.render('email.tmpl', function (err: any, str: any) {
          if (err) return done(err);
    ...
    describe('when "view engine" is given', function(){
      it('should render the template', function (done: any){
        ...
        app.render('email', function (err: any, str: any){
          if (err) return done(err);
          assert.strictEqual(str, '<p>This is an email</p>')
          done();
        })
    ...
    describe('when "views" is given', function(){
      ...
      describe('when array of paths', function(){
        ...
        it('should lookup in later paths until found', function (done: any){
          ...
          app.render('name.tmpl', function (err: any, str: any) {
            if (err) return done(err);
            assert.strictEqual(str, '<p>tobi</p>')
            done();
          })
        ...
        it('should error if file does not exist', function (done: any){
          const app = createApp();
          const views = [
            path.join(__dirname, 'fixtures', 'local_layout'),
            path.join(__dirname, 'fixtures', 'default_layout')
          ...
          app.render('pet.tmpl', function (err: any, str: any) {
            assert.ok(err)
    ...
    describe('when a "view" constructor is given', function(){
      it('should create an instance of it', function (done: any){
        const app = express();
  ...
  describe('.render(name, options, fn)', function(){
    it('should render the template', function (done: any){
      ...
      app.render('user.tmpl', { user: user }, function (err: any, str: any) {
        if (err) return done(err);
        assert.strictEqual(str, '<p>tobi</p>')
        done();
      })
    ...
    it('should give precedence to app.render() locals', function (done: any){
      const app = createApp();
      ...
      app.render('user.tmpl', { user: jane }, function (err: any, str: any) {
        if (err) return done(err);
    ...
    describe('caching', function(){
      it('should cache with cache option', function (done: any){
        ...
        app.render('something', {cache: true}, function (err: any, str: any){
          if (err) return done(err);
          assert.strictEqual(count, 1)
          assert.strictEqual(str, 'abstract engine')
          app.render('something', {cache: true}, function (err: any, str: any){
