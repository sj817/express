...
const app = import('../../examples/downloads.ts')
  
import request from 'supertest';

describe('downloads', function(){
  describe('GET /', function(){
    it('should have a link to amazing.txt', function (done: any){
      request(app)
      .get('/')
  ...
  describe('GET /files/notes/groceries.txt', function () {
    it('should have a download header', function (done: any) {
      request(app)
  ...
  describe('GET /files/../index.js', function () {
    it('should respond with 403', function (done: any) {
      request(app)
        .get('/files/../index.js')
        .expect(403, done)
    })
