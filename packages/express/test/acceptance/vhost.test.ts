...
const app = import('../../examples/vhost.ts')
import request from 'supertest'

describe('vhost', function(){
  describe('example.com', function(){
    describe('GET /', function(){
      it('should say hello', function (done: any){
        request(app)
        .get('/')
    ...
    describe('GET /foo', function(){
      it('should say foo', function (done: any){
        request(app)
        .get('/foo')
        .set('Host', 'example.com')
  ...
  describe('foo.example.com', function(){
    describe('GET /', function(){
      it('should redirect to /foo', function (done: any){
        request(app)
        .get('/')
  ...
  describe('bar.example.com', function(){
    describe('GET /', function(){
      it('should redirect to /bar', function (done: any){
        request(app)
        .get('/')
