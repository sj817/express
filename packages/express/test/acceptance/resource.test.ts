...
const app = import('../../examples/resource.ts')
...
describe('resource', function(){
  ...
  describe('GET /users', function(){
    it('should respond with all users', function (done: any){
      request(app)
        .get('/users')
  ...
  describe('GET /users/1', function(){
    it('should respond with user 1', function (done: any){
      request(app)
        .get('/users/1')
  ...
  describe('GET /users/9', function(){
    it('should respond with error', function (done: any){
      request(app)
        .get('/users/9')
  ...
  describe('GET /users/1..3', function(){
    it('should respond with users 1 through 3', function (done: any){
      request(app)
        .get('/users/1..3')
  ...
  describe('DELETE /users/1', function(){
    it('should delete user 1', function (done: any){
      request(app)
        .del('/users/1')
  ...
  describe('DELETE /users/9', function(){
    it('should fail', function (done: any){
      request(app)
        .del('/users/9')
  ...
  describe('GET /users/1..3.json', function(){
    it('should respond with users 2 and 3 as json', function (done: any){
      request(app)
        .get('/users/1..3.json')
