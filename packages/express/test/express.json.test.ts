...
describe('express.json()', function () {
  it('should parse JSON', function (done: any) {
    request(createApp())
      .post('/')
  ...
  it('should handle Content-Length: 0', function (done: any) {
    request(createApp())
      .post('/')
      .set('Content-Type', 'application/json')
  ...
  it('should handle empty message-body', function (done: any) {
    request(createApp())
      .post('/')
      .set('Content-Type', 'application/json')
  ...
  it('should handle no message-body', function (done: any) {
    request(createApp())
      .post('/')
      .set('Content-Type', 'application/json')
  ...
  it('should 400 when only whitespace', function (done: any) {
    request(createApp())
      .post('/')
      .set('Content-Type', 'application/json')
      .send('  \n')
  ...
  it('should 400 when invalid content-length', function (done: any) {
    const app = express()
  ...
  it('should handle duplicated middleware', function (done: any) {
    const app = express()
  ...
  describe('when JSON is invalid', function () {
    ...
    it('should 400 for bad token', function (done: any) {
      request(this.app)
        .post('/')
        .set('Content-Type', 'application/json')
        .send('{:')
    ...
    it('should 400 for incomplete', function (done: any) {
      request(this.app)
        .post('/')
        .set('Content-Type', 'application/json')
        .send('{"user"')
    ...
    it('should include original body on error object', function (done: any) {
      request(this.app)
        .post('/')
        .set('Content-Type', 'application/json')
  ...
  describe('with limit option', function () {
    it('should 413 when over limit with Content-Length', function (done: any) {
    ...
    it('should 413 when over limit with chunked encoding', function (done: any) {
    ...
    it('should 413 when inflated body over limit', function (done: any) {
      const app = createApp({ limit: '1kb' })
      const test = request(app).post('/')
    ...
    it('should accept number of bytes', function (done: any) {
      const buf = Buffer.alloc(1024, '.')
    ...
    it('should not change when options altered', function (done: any) {
      const buf = Buffer.alloc(1024, '.')
    ...
    it('should not hang response', function (done: any) {
    ...
    it('should not error when inflating', function (done: any) {
      const app = createApp({ limit: '1kb' })
      const test = request(app).post('/')
      test.set('Content-Encoding', 'gzip')
      test.set('Content-Type', 'application/json')
  ...
  describe('with inflate option', function () {
    describe('when false', function () {
      ...
      it('should not accept content-encoding', function (done: any) {
    ...
    describe('when true', function () {
      ...
      it('should accept content-encoding', function (done: any) {
        const test = request(this.app).post('/')
        test.set('Content-Encoding', 'gzip')
        test.set('Content-Type', 'application/json')
        test.write(Buffer.from('1f8b080000000000000bab56ca4bcc4d55b2527ab16e97522d00515be1cc0e000000', 'hex'))
  ...
  describe('with strict option', function () {
    describe('when undefined', function () {
      ...
      it('should 400 on primitives', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/json')
          .send('true')
    ...
    describe('when false', function () {
      ...
      it('should parse primitives', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/json')
          .send('true')
    ...
    describe('when true', function () {
      ...
      it('should not parse primitives', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/json')
          .send('true')
      ...
      it('should not parse primitives with leading whitespaces', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/json')
          .send('    true')
      ...
      it('should allow leading whitespaces in JSON', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/json')
          .send('   { "user": "tobi" }')
      ...
      it('should include correct message in stack trace', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/json')
  ...
  describe('with type option', function () {
    describe('when "application/vnd.api+json"', function () {
      ...
      it('should parse JSON for custom type', function (done: any) {
        request(this.app)
          .post('/')
      ...
      it('should ignore standard type', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/json')
          .send('{"user":"tobi"}')
    ...
    describe('when ["application/json", "application/vnd.api+json"]', function () {
      ...
      it('should parse JSON for "application/json"', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/json')
          .send('{"user":"tobi"}')
      ...
      it('should parse JSON for "application/vnd.api+json"', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/vnd.api+json')
          .send('{"user":"tobi"}')
      ...
      it('should ignore "application/x-json"', function (done: any) {
        request(this.app)
          .post('/')
    ...
    describe('when a function', function () {
      it('should parse when truthy value returned', function (done: any) {
      ...
      it('should work without content-type', function (done: any) {
        const app = createApp({ type: accept })
      ...
      it('should not invoke without a body', function (done: any) {
        const app = createApp({ type: accept })
  ...
  describe('with verify option', function () {
    ...
    it('should error from verify', function (done: any) {
      const app = createApp({
    ...
    it('should allow custom codes', function (done: any) {
      const app = createApp({
        verify: function (req, res, buf) {
    ...
    it('should allow custom type', function (done: any) {
      const app = createApp({
        verify: function (req, res, buf) {
          if (buf[0] !== 0x5b) return
          const err = new Error('no arrays')
    ...
    it('should allow pass-through', function (done: any) {
      const app = createApp({
        verify: function (req, res, buf) {
          if (buf[0] === 0x5b) throw new Error('no arrays')
        }
    ...
    it('should work with different charsets', function (done: any) {
      const app = createApp({
        verify: function (req, res, buf) {
          if (buf[0] === 0x5b) throw new Error('no arrays')
        }
    ...
    it('should 415 on unknown charset prior to verify', function (done: any) {
      const app = createApp({
        verify: function (req, res, buf) {
  ...
  describe('async local storage', function () {
    ...
    it('should persist store when unmatched content-type', function (done: any) {
      request(this.app)
        .post('/')
    ...
    it('should persist store when inflated', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Encoding', 'gzip')
      test.set('Content-Type', 'application/json')
      test.write(Buffer.from('1f8b080000000000000bab56ca4bcc4d55b2527ab16e97522d00515be1cc0e000000', 'hex'))
    ...
    it('should persist store when inflate error', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Encoding', 'gzip')
      test.set('Content-Type', 'application/json')
    ...
    it('should persist store when parse error', function (done: any) {
      request(this.app)
        .post('/')
        .set('Content-Type', 'application/json')
        .send('{"user":')
    ...
    it('should persist store when limit exceeded', function (done: any) {
      request(this.app)
        .post('/')
        .set('Content-Type', 'application/json')
  ...
  describe('charset', function () {
    ...
    it('should parse utf-8', function (done: any) {
      const test = request(this.app).post('/')
    ...
    it('should parse utf-16', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Type', 'application/json; charset=utf-16')
      test.write(Buffer.from('feff007b0022006e0061006d00650022003a00228bba0022007d', 'hex'))
      test.expect(200, '{"name":"论"}', done)
    ...
    it('should parse when content-length != char length', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Type', 'application/json; charset=utf-8')
    ...
    it('should default to utf-8', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Type', 'application/json')
      test.write(Buffer.from('7b226e616d65223a22e8aeba227d', 'hex'))
      test.expect(200, '{"name":"论"}', done)
    ...
    it('should fail on unknown charset', function (done: any) {
      const test = request(this.app).post('/')
  ...
  describe('encoding', function () {
    ...
    it('should parse without encoding', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Type', 'application/json')
      test.write(Buffer.from('7b226e616d65223a22e8aeba227d', 'hex'))
      test.expect(200, '{"name":"论"}', done)
    ...
    it('should support identity encoding', function (done: any) {
      const test = request(this.app).post('/')
    ...
    it('should support gzip encoding', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Encoding', 'gzip')
      test.set('Content-Type', 'application/json')
      test.write(Buffer.from('1f8b080000000000000bab56ca4bcc4d55b2527ab16e97522d00515be1cc0e000000', 'hex'))
    ...
    it('should support deflate encoding', function (done: any) {
      const test = request(this.app).post('/')
    ...
    it('should be case-insensitive', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Encoding', 'GZIP')
      test.set('Content-Type', 'application/json')
      test.write(Buffer.from('1f8b080000000000000bab56ca4bcc4d55b2527ab16e97522d00515be1cc0e000000', 'hex'))
    ...
    it('should 415 on unknown encoding', function (done: any) {
      const test = request(this.app).post('/')
    ...
    it('should 400 on malformed encoding', function (done: any) {
      const test = request(this.app).post('/')
      test.set('Content-Encoding', 'gzip')
      test.set('Content-Type', 'application/json')
      test.write(Buffer.from('1f8b080000000000000bab56cc4d55b2527ab16e97522d00515be1cc0e000000', 'hex'))
    ...
    it('should 413 when inflated value exceeds limit', function (done: any) {
