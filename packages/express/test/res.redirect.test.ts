...
describe('res', function(){
  describe('.redirect(url)', function(){
    it('should default to a 302 redirect', function (done: any){
      const app = express();
  ...
  describe('.redirect(status, url)', function(){
    it('should set the response status', function (done: any){
      const app = express();
  ...
  describe('when accepting html', function(){
    ...
    it('should escape the url', function (done: any){
      const app = express();
    ...
    it('should not render evil javascript links in anchor href (prevent XSS)', function (done: any){
      const app = express();
    ...
    it('should include the redirect type', function (done: any){
      const app = express();
  ...
  describe('when accepting text', function(){
    it('should respond with text', function (done: any){
      const app = express();
    ...
    it('should encode the url', function (done: any){
      const app = express();
  ...
  describe('when accepting neither text or html', function(){
    it('should respond with an empty body', function (done: any){
      const app = express();
