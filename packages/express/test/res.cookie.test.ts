...
describe('res', function(){
  describe('.cookie(name, object)', function(){
    it('should generate a JSON cookie', function (done: any){
      const app = express();
  ...
  describe('.cookie(name, string)', function(){
    ...
    it('should allow multiple calls', function (done: any){
      const app = express();
  ...
  describe('.cookie(name, string, options)', function(){
    it('should set params', function (done: any){
      const app = express();
    ...
    describe('expires', function () {
      it('should throw on invalid date', function (done: any) {
        const app = express()
    ...
    describe('partitioned', function () {
      it('should set partitioned', function (done: any) {
        const app = express();
    ...
    describe('maxAge', function(){
      it('should set relative expires', function (done: any){
        const app = express();
      ...
      it('should set max-age', function (done: any){
        const app = express();
      ...
      it('should not mutate the options object', function (done: any){
        const app = express();
      ...
      it('should not throw on null', function (done: any) {
        const app = express()
      ...
      it('should not throw on undefined', function (done: any) {
        const app = express()
      ...
      it('should throw an error with invalid maxAge', function (done: any) {
        const app = express()
    ...
    describe('priority', function () {
      it('should set low priority', function (done: any) {
        const app = express()
      ...
      it('should set medium priority', function (done: any) {
        const app = express()
      ...
      it('should set high priority', function (done: any) {
        const app = express()
      ...
      it('should throw with invalid priority', function (done: any) {
        const app = express()
    ...
    describe('signed', function(){
      it('should generate a signed JSON cookie', function (done: any){
        const app = express();
    ...
    describe('.signedCookie(name, string)', function(){
      it('should set a signed cookie', function (done: any){
        const app = express();
