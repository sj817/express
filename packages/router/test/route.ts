...
import { assert, createHitHandle, createServer, request, shouldHaveBody, shouldHitHandle, shouldNotHaveBody, shouldNotHitHandle, methods } from './support/utils.js'
...
describe('Router', function () {
  describe('.route(path)', function () {
    ...
    it('should respond to multiple methods', function (done: any) {
      const router = new Router()
      const route = router.route('/foo')
    ...
    it('should route without method', function (done: any) {
      const router = new Router()
      const route = router.route('/foo')
    ...
    it('should not error on empty route', function (done: any) {
      const router = new Router()
      const route = router.route('/foo')
      const server = createServer(router)
    ...
    it('should not invoke singular error route', function (done: any) {
      const router = new Router()
      const route = router.route('/foo')
      const server = createServer(router)

      route.all(function handleError (err: any, req: any, res: any, next: any) {
    ...
    it('should not stack overflow with a large sync stack', function (done: any) {
      ...
      for (let i = 0; i < 6000; i++) {
        route.all(function (req: any, res: any, next: any) { next() })
      }
    ...
    describe('.all(...fn)', function () {
      ...
      it('should accept single array of handlers', function (done: any) {
        const router = new Router()
        const route = router.route('/foo')
        const server = createServer(router)
      ...
      it('should accept nested arrays of handlers', function (done: any) {
        const router = new Router()
        const route = router.route('/foo')
        const server = createServer(router)
    ...
    methods.slice().sort().forEach(function (method) {
      ...
      describe('.' + method + '(...fn)', function () {
        it('should respond to a ' + method.toUpperCase() + ' request', function (done: any) {
          ...
          (route as any)[method](helloWorld);
        ...
        it('should reject no arguments', function () {
          const router = new Router()
          const route = router.route('/')
          assert.throws((route as any)[method].bind(route), /argument handler is required/)
        })
        ...
        it('should reject invalid fn', function () {
          const router = new Router()
          const route = router.route('/')
          assert.throws((route as any)[method].bind(route, 2), /argument handler must be a function/)
        })
        ...
        it('should accept multiple arguments', function (done: any) {
          ...
          (route as any)[method](createHitHandle(1), createHitHandle(2), helloWorld);
        ...
        it('should accept nested arrays of handlers', function (done: any) {
          ...
          (route as any)[method]([[createHitHandle(1), createHitHandle(2)], createHitHandle(3)], helloWorld);
    ...
    describe('error handling', function () {
      it('should handle errors from next(err)', function (done: any) {
        const router = new Router()
        const route = router.route('/foo')
        const server = createServer(router)

        route.all(function createError (req: any, res: any, next: any) {
          next(new Error('boom!'))
        })
      ...
      it('should handle errors thrown', function (done: any) {
        const router = new Router()
        const route = router.route('/foo')
        const server = createServer(router)
      ...
      it('should handle errors thrown in error handlers', function (done: any) {
        const router = new Router()
        const route = router.route('/foo')
        const server = createServer(router)
    ...
    describe('next("route")', function () {
      it('should invoke next handler', function (done: any) {
        ...
        route.get(function handle (req: any, res: any, next: any) {
      ...
      it('should invoke next route', function (done: any) {
        const router = new Router()
        const route = router.route('/foo')
        const server = createServer(router)
      ...
      it('should skip next handlers in route', function (done: any) {
        const router = new Router()
        const route = router.route('/foo')
        const server = createServer(router)

        route.all(createHitHandle(1))
        route.get(function goNext (req: any, res: any, next: any) {
          res.setHeader('x-next', 'route')
          next('route')
        })
        route.all(createHitHandle(2))
      ...
      it('should not invoke error handlers', function (done: any) {
        ...
        route.all(function goNext (req: any, res: any, next: any) {
          res.setHeader('x-next', 'route')
          next('route')
        })
    ...
    describe('path', function () {
      describe('using ":name"', function () {
        it('should name a capture group', function (done: any) {
          const router = new Router()
          const route = router.route('/:foo')
          const server = createServer(router)
        ...
        it('should match single path segment', function (done: any) {
          const router = new Router()
          const route = router.route('/:foo')
          const server = createServer(router)
        ...
        it('should work multiple times', function (done: any) {
          const router = new Router()
        ...
        it('should work inside literal parentheses', function (done: any) {
          const router = new Router()
        ...
        it('should work within arrays', function (done: any) {
          const router = new Router()
      ...
      describe('using "{:name}"', function () {
        it('should name an optional parameter', function (done: any) {
          const router = new Router()
          const route = router.route('{/:foo}')
          const server = createServer(router)
        ...
        it('should work in any segment', function (done: any) {
          const router = new Router()
      ...
      describe('using "*name"', function () {
        it('should name a zero-or-more repeated parameter', function (done: any) {
          const router = new Router()
          const route = router.route('{/*foo}')
          const server = createServer(router)
      ...
      describe('using regular expression with param name "(?<name>pattern)"', function () {
        it('should limit capture group to regexp match', function (done: any) {
          const router = new Router()
      ...
      describe('using "(regexp)"', function () {
        it('should add capture group using regexp', function (done: any) {
          const router = new Router()
...
function sendParams (req: any, res: any) {
  res.statusCode = 200
