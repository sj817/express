...
describe('req', function(){
  describe('.get(field)', function(){
    it('should return the header field value', function (done: any){
      const app = express();
    ...
    it('should special-case Referer', function (done: any){
      const app = express();
    ...
    it('should throw missing header name', function (done: any) {
      const app = express()
    ...
    it('should throw for non-string header name', function (done: any) {
      const app = express()
