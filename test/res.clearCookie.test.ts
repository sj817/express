...
describe('res', function(){
  describe('.clearCookie(name)', function(){
    it('should set a cookie passed expiry', function (done: any){
      const app = express();
  ...
  describe('.clearCookie(name, options)', function(){
    it('should set the given params', function (done: any){
      const app = express();
    ...
    it('should ignore user supplied expires param', function (done: any){
      const app = express();
