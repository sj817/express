...
describe('express.urlencoded()', function () {
  ...
  it('should parse x-www-form-urlencoded', function (done: any) {
    request(this.app)
      .post('/')
  ...
  it('should not parse extended syntax', function (done: any) {
    request(this.app)
      .post('/')
      .set('Content-Type', 'application/x-www-form-urlencoded')
  ...
  describe('with extended option', function () {
    describe('when false', function () {
      ...
      it('should parse multiple key instances', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
    ...
    describe('when true', function () {
      ...
      it('should parse extended syntax', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
          .send('user[name][first]=Tobi')
      ...
      it('should parse fully-encoded extended syntax', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      it('should parse array index notation', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      it('should parse array of objects syntax', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
  ...
  describe('with parameterLimit option', function () {
    describe('with extended: false', function () {
      ...
      it('should 413 if over limit', function (done: any) {
      ...
      it('should work when at the limit', function (done: any) {
        request(createApp({ extended: false, parameterLimit: 10 }))
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      it('should work if number is floating point', function (done: any) {
      ...
      it('should work with large limit', function (done: any) {
      ...
      it('should work with Infinity limit', function (done: any) {
  ...
  describe('with type option', function () {
    describe('when "application/vnd.x-www-form-urlencoded"', function () {
      ...
      it('should parse for custom type', function (done: any) {
        request(this.app)
          .post('/')
    ...
    describe('when ["urlencoded", "application/x-pairs"]', function () {
      ...
      it('should parse "application/x-www-form-urlencoded"', function (done: any) {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
          .send('user=tobi')
      ...
      it('should parse "application/x-pairs"', function (done: any) {
        request(this.app)
          .post('/')
      ...
      it('should ignore application/x-foo', function (done: any) {
        request(this.app)
          .post('/')
