  ...
  describe('.ip', function(){
    describe('when X-Forwarded-For is present', function(){
      describe('when "trust proxy" is enabled', function(){
        it('should return the client addr', function (done: any){
          const app = express();
        ...
        it('should return the addr after trusted proxy based on count', function (done: any) {
          const app = express();
        ...
        it('should return the addr after trusted proxy based on list', function (done: any) {
          const app = express()
        ...
        it('should return the addr after trusted proxy, from sub app', function (done: any) {
          const app = express();
          const sub = express();
          ...
          sub.use(function (req: any, res: any, next: any) {
            res.send(req.ip);
          });
      ...
      describe('when "trust proxy" is disabled', function(){
        it('should return the remote address', function (done: any){
          const app = express();
