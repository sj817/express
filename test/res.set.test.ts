...
describe('res', function(){
  describe('.set(field, value)', function(){
    it('should set the response header field', function (done: any){
      const app = express();
    ...
    it('should coerce to a string', function (done: any) {
      const app = express();
  ...
  describe('.set(field, values)', function(){
    it('should set multiple response header fields', function (done: any){
      const app = express();
    ...
    it('should coerce to an array of strings', function (done: any) {
      const app = express();
    ...
    it('should not set a charset of one is already set', function (done: any) {
      const app = express();
    ...
    it('should throw when Content-Type is an array', function (done: any) {
      const app = express()
  ...
  describe('.set(object)', function(){
    it('should set multiple fields', function (done: any){
      const app = express();
