...
describe('req', function(){
  describe('.subdomains', function(){
    describe('when present', function(){
      it('should return an array', function (done: any){
        const app = express();
      ...
      it('should work with IPv4 address', function (done: any){
        const app = express();
      ...
      it('should work with IPv6 address', function (done: any){
        const app = express();
    ...
    describe('when subdomain offset is set', function(){
      describe('when subdomain offset is zero', function(){
        it('should return an array with the whole domain', function (done: any){
          const app = express();
        ...
        it('should return an array with the whole IPv4', function (done: any) {
          const app = express();
          app.set('subdomain offset', 0);
        ...
        it('should return an array with the whole IPv6', function (done: any) {
          const app = express();
          app.set('subdomain offset', 0);
