...
const app = import('../../examples/route-separation.ts')
import request from 'supertest'

describe('route-separation', function () {
  describe('GET /', function () {
    it('should respond with index', function (done: any) {
      request(app)
      .get('/')
  ...
  describe('GET /users', function () {
    it('should list users', function (done: any) {
      request(app)
      .get('/users')
      .expect(/TJ/)
      .expect(/Tobi/)
  ...
  describe('GET /user/:id', function () {
    ...
    it('should 404 on missing user', function (done: any) {
      request(app)
      .get('/user/10')
      .expect(404, done)
    })
  ...
  describe('GET /user/:id/edit', function () {
    it('should get a user to edit', function (done: any) {
      request(app)
      .get('/user/0/edit')
  ...
  describe('PUT /user/:id/edit', function () {
    it('should edit a user', function (done: any) {
      request(app)
      .put('/user/0/edit')
      .set('Content-Type', 'application/x-www-form-urlencoded')
      .send({ user: { name: 'TJ', email: 'tj-invalid@vision-media.ca' } })
      .expect(302, function (err: any) {
  ...
  describe('GET /posts', function () {
    it('should get a list of posts', function (done: any) {
      request(app)
      .get('/posts')
