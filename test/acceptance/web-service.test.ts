...
describe('web-service', function(){
  describe('GET /api/users', function(){
    describe('without an api key', function(){
      it('should respond with 400 bad request', function (done: any){
        request(app)
        .get('/api/users')
        .expect(400, done);
      })
    ...
    describe('with an invalid api key', function(){
      it('should respond with 401 unauthorized', function (done: any){
        request(app)
    ...
    describe('with a valid api key', function(){
      it('should respond users json', function (done: any){
        request(app)
  ...
  describe('GET /api/repos', function(){
    ...
    describe('with a valid api key', function(){
      it('should respond repos json', function (done: any){
        request(app)
  ...
  describe('GET /api/user/:name/repos', function(){
    ...
    describe('with a valid api key', function(){
      it('should respond user repos json', function (done: any){
        request(app)
      ...
      it('should 404 with unknown user', function (done: any){
        request(app)
  ...
  describe('when requesting an invalid route', function(){
    it('should respond with 404 json', function (done: any){
      request(app)
