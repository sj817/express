...
const app = import('../../examples/multi-router.ts')
import request from 'supertest'

describe('multi-router', function(){
  describe('GET /',function(){
    it('should respond with root handler', function (done: any){
      request(app)
      .get('/')
  ...
  describe('GET /api/v1/',function(){
    it('should respond with APIv1 root handler', function (done: any){
      request(app)
      .get('/api/v1/')
  ...
  describe('GET /api/v1/users',function(){
    it('should respond with users from APIv1', function (done: any){
      request(app)
      .get('/api/v1/users')
  ...
  describe('GET /api/v2/',function(){
    it('should respond with APIv2 root handler', function (done: any){
      request(app)
      .get('/api/v2/')
  ...
  describe('GET /api/v2/users',function(){
    it('should respond with users from APIv2', function (done: any){
      request(app)
      .get('/api/v2/users')
