...
describe('req.is()', function () {
  describe('when given a mime type', function () {
    it('should return the type when matching', function (done: any) {
      const app = express()
    ...
    it('should return false when not matching', function (done: any) {
      const app = express()
  ...
  describe('when content-type is not present', function(){
    it('should return false', function (done: any) {
      const app = express()
  ...
  describe('when given an extension', function(){
    it('should lookup the mime type', function (done: any) {
      const app = express()
  ...
  describe('when given */subtype', function(){
    it('should return the full type when matching', function (done: any) {
      const app = express()
