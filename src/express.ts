...
import { req, type Request } from './request'
import { res, type Response } from './response'
...
export interface Express extends Omit<Application, 'request' | 'response'> {
  request: Request & { app: Express }
  response: Response & { app: Express }
}
...
export { urlencoded } from 'body-parser'
